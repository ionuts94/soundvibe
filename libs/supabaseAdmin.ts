...
export const upsertProductRecord = async (product: Product) => {
...
export const createOrRetrieveCustomer = async ({ email, userId }: CustomerData) => {
...
export const manageSubscriptionStatusChange = async (
  ...
  console.log(`Inserted / Updated subscription '${subscription.id}' for '${userId}'`);
